...
pub trait Actor {
    ...
    fn speed(&self) -> i32;
    fn pos_body(&self) -> i32; //fn aggiunte per evidenziare la posizione del corpo e della testa del coccodrillo
    fn pos_head(&self) -> i32; //in modo da confrontarle con la pos della rana, se la pos della rana coincide con quella della testa del coccodrillo la rana muore, altrimenti se la pos della rana coincide con la pos del corpo del coccodrillo la rana è salva.
}
