		...
		<table class="form-style-5">
			...
			<div class="form-style-5">
				<form action="ServerSQL.php" method="POST">
					<fieldset>
						<legend><span class="number">*</span> Info Giocatore </legend>
						<input type="text" name="card" placeholder="Tessera..." required>
						...
						<input type="number" name="number_shirt" placeholder="Numero maglia..." min=1 max=99 required>
						<input type="text" name="name_g" placeholder="Nome giocatore..." required>
						<input type="text" name="surname_g" placeholder="Cognome giocatore..." required>
						<select name="role">
						...
						<input type="text" name="nationality" placeholder="Nazionalità..." required>     
					</fieldset>
				<input type="submit" name="btnAddPlayer" value="Aggiungi" />
				</form>
			</div>
			</td>
		</table>
